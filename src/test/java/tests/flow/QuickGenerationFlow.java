...
public class QuickGenerationFlow {
    ...
    public void step10_getGenerationStatus() {
        System.out.println("▶ Step 10: Get Generation Status (wait until completed)");
        new GetGenerationStatusTest().waitUntilAllCompleted();
    }

    @Test(dependsOnMethods = "step10_getGenerationStatus")
    public void step11_getTSByBR() {
    ...
    public void step13_waitForTCCompletion() throws InterruptedException {
        ...
        new GetGenerationStatusTest().waitUntilAllCompletedfortc();
